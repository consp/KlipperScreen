...
class WifiManager:
    ...
    def delete_network(self, ssid):
        logging.warning('delete_network')
        netid = None
        for i in list(self.supplicant_networks):
            if self.supplicant_networks[i]['ssid'] == ssid:
                netid = i
    ...
    def get_current_wifi(self):
        logging.warning("get_current_wifi")
    ...
    def read_wpa_supplicant(self):
        # returns nothing ...
        #data = subprocess.check_output(['iwctl %s known-networks' % self.interface], shell=True, timeout=5)
